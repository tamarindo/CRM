...
class UserProfile(models.Model):
    ...
    date_bonding = models.DateField(null=True, verbose_name=_("Fecha de vinculacion"), blank=True)
    # ------ datos para todas las tablas
    is_active = models.BooleanField(default=True)
    date_added = models.DateTimeField(auto_now_add=True)
    date_modified = models.DateTimeField(auto_now=True)
...
class publicidad(models.Model):
    Service = models.OneToOneField(Service, verbose_name=_("Service") ,null=True)
    imagen = models.ImageField(upload_to='publicidad', verbose_name='Imagen')
    descripcion = models.CharField(max_length=60, verbose_name=_("descripcion"), null=True, blank=True)
    orden = models.IntegerField(max_length=20,verbose_name=_("orden"))
        # ------ datos para todas las tablas
    is_active = models.BooleanField(default=True)
    date_added = models.DateTimeField(auto_now_add=True)
    date_modified = models.DateTimeField(auto_now=True)
